...
function EditDataModal({ isOpen, onClose }) {
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      portalId="modal-root-2"
      closeIcon={
        <FaXmark className="text-gray-500 hover:text-gray-700 transition-colors" />
      }
    >
      <div className="w-200 bg-white p-4 rounded-lg flex flex-col">
        <Modal.Header>
          ...
          <p className="text-gray-400 mb-2">
            Edite as informações do pet e seu dono
          </p>
        </Modal.Header>
